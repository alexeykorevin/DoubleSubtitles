...
Программа для создания двойных субтитров, которые необходимы в изучении иностранного языка при просмотре сериалов/фильмов в оригинале. Объединение происходит по временному интервалу. Алгоритм основан на агломеративной иерархической кластеризации.
